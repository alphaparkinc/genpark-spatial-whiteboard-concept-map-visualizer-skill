# genpark-spatial-whiteboard-concept-map-visualizer-skill
...
> **GenPark AI Agent Skill** -- Spatial whiteboard concept map and thinking flow visualizer (Heptabase style)
